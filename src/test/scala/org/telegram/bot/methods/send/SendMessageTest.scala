...
class SendMessageTest {
    ...
    class SendMessageTestable(token: String) extends SendMessage(token) {
    ...
    @Test def test(): Unit = {
        ...
        //compare just toString because complete comparison will yield false for some internal variable
